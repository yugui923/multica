...
Guidance for coding agents working in this repository. Keep this file short and authoritative: rules here should be hard to infer from code or easy to get wrong.
...
- `apps/mobile/`: Expo / React Native iOS app. Read `apps/mobile/AGENTS.md` before touching it.
...
Read `apps/mobile/AGENTS.md` before touching `apps/mobile/`. It contains the mandatory pre-flight process, import limits, parity rules, tech stack, UI rules, data helpers, realtime strategy, and mobile release flow.
