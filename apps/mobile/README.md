...
Expo + React Native iOS client for Multica. Independent from web/desktop — shares only types from `@multica/core/`. See [`AGENTS.md`](./AGENTS.md) for the locked tech-stack baseline and import rules.
